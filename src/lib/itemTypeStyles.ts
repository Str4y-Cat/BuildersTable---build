...
const badgeClasses: Record<ItineraryItemType, string> = {
  ...
  accommodation: 'border-transparent bg-purple-100 text-purple-800 hover:bg-purple-100',
  ...
  'call-time': 'border-transparent bg-orange-100 text-orange-800 hover:bg-orange-100',
